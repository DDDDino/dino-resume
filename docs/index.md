...
<p><span class="lead">AI 落地经验</span>曾在头部新能源车企做<strong>车娱及模型语音互动项目</strong>；现在 B2B 头部医药平台负责<strong>搜索策略、推荐内容分发、交易转化</strong>相关内容；近期负责 <strong>AI 审核提效</strong>相关产品，覆盖用户端、商家侧、运营侧等多角色协同场景。</p>
<p><span class="lead">核心能力</span>擅长将业务问题拆解为<strong>流程、规则、指标与系统方案</strong>，具备取数分析、需求建模、跨团队推进和 AI 工具辅助产品工作的能力。</p>
</div>
</section>
